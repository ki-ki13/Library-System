...
<div class="text-center" id="body">
    ...
    <form method="post" action="?p=loginUser_proses">
    ...
    <p style="margin-top : 10px">Bukan anggota ? Silahkan <a href="?p=daftar">Daftar</a></p>
    <p style="margin-top : 10px"> <a href="?p=loginAdmin">Login Admin</a></p>
</div>
</div>